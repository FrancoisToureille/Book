...
public class BookApplication extends Application {
    ...
    private BookRepositoryInterface openDbConnection(){
        ...
        try{
            db = new BookRepositoryMariadb("jdbc:mariadb://mysql-francoistoureille.alwaysdata.net/francoistoureille_library_db", "280938_library", "AlwaysData78.");
        }
        catch (Exception e){
